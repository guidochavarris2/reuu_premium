...
/*
        ...
        images.add(new SlideModel(R.drawable.portada1, null));
        images.add(new SlideModel(R.drawable.portada2, null));
        images.add(new SlideModel(R.drawable.portada3, null));
        images.add(new SlideModel(R.drawable.portada4, null));

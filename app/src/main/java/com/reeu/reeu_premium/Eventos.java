...
//import static com.reeu.reeu_premium.R.id.lisMostraMisEventos;
//import static com.example.reeu_premium.R.id.lisMostrar;
//import static com.reeu.reeu_premium.R.id.lisMostrarEntradas;
...
public class Eventos extends AppCompatActivity implements View.OnClickListener{
    ...
    //nuevo
    public static ArrayList<Usuarios> usuariosArrayListEvento=new ArrayList<>();
    public static ArrayList<Usuarios> usuariosArrayListInvitado=new ArrayList<>();
    Usuarios usuarios;
    Usuarios usuarios2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boton_Agregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Eventos.this, Buscador.class);
                startActivity(intent);
            }
        });
...
/*
                        ...
                        try {
                            ...
                            if (!obj.getBoolean("error")) {
                                ...
                                for (int i = 0; i < userJson.length(); i++) {
                                    ...
                                    usuariosArrayListEvento.add(usuarios);
                                }
                                AdapterEvento adapter = new AdapterEvento(Eventos.this, productosList, new RecyclerViewAdapter.ItemClickListener() {
                                    @Override
                                    public void onItemClick(Usuarios item2) {
                                        ToDetalleEvento2(item2);
                                    }
                                });
                        ...
                        try {
                            ...
                            if (!obj.getBoolean("error")) {
                                ...
                                for (int i = 0; i < userJson.length(); i++) {
                                    ...
                                    productosList2.add(new Usuarios(
                                            Usuarios.getString("nombre"),
                                            Usuarios.getString("aforo"),
                                            Usuarios.getString("descripcion"),
                                            Usuarios.getString("id_evento"),
                                    ...
                                    usuarios2 = new Usuarios(id,codigo, categoria, id_evento, fecha, hora, ubicacion, imagen, estado, tipo_evento, id_usuario);
                                    usuariosArrayListInvitado.add(usuarios2);
                                }
                                AdapterInvitado adapter = new AdapterInvitado(Eventos.this, productosList2, new RecyclerViewAdapter.ItemClickListener() {
                                    @Override
    ...
    public void ToDetalleEvento(Usuarios item) {
        Intent intent = new Intent(this, DetalleEventoIngresado.class);
        intent.putExtra("item", item);
        startActivity(intent);
    }

    public void ToDetalleEvento2(Usuarios item2) {
        Intent intent = new Intent(this, DetalleEventoAdmin.class);

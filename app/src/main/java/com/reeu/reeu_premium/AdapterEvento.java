...
public class AdapterEvento extends RecyclerView.Adapter<AdapterEvento.PlayerViewnHolder> {

    private Context mCtx;
    private List<Usuarios>productosList;
    private RecyclerViewAdapter.ItemClickListener mItemClickListener;
    public AdapterEvento(Context mCtx, List<Usuarios> productosList, RecyclerViewAdapter.ItemClickListener itemClickListener){
        this.mCtx=mCtx;
